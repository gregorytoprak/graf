  ...
  render () {
    ...
    return (
      <ButtonGroup className='Sidebar' vertical>
        <Button onClick={this.props.showWelcome}><Glyphicon glyph='menu-hamburger' /></Button>
        <OverlayTrigger placement='right' trigger='click' rootClose containerPadding={40} overlay={styleEditor}>
